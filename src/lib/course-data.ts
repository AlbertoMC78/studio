...
export const courseData: CourseModule[] = [
  ...
  },
  {
    ...
    classes: [
      { id: '5.1', title: 'Introducción a DevOps', content: '', duration: 60 },
      { id: '5.2', title: 'Docker básico', content: '', duration: 90 },
      { id: '5.3', title: 'Docker Compose y entornos escalables', content: '', duration: 90 },
      { id: '5.4', title: 'GitHub Actions y CI/CD', content: '', duration: 120 },
